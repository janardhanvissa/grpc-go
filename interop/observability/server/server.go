...
/*
Package main provides a gRPC server with observability integration for testing purposes.
...
TestService from the interop package, which is used for interoperability
testing. The server starts observability and sets up logging for server
activity. The server will stop gracefully when the application exits.
*/
